ChallengeElo::Application.configure do
  ...
  #config.action_mailer.default_url_options = { :host => 'staging.clipesebandas.com.br' }
  #config.action_mailer.delivery_method = :smtp
  #config.action_mailer.smtp_settings = {
  #  :address => 'smtp.sendgrid.net',
  #  :port => '25',
  #  :domain => 'staging.clipesebandas.com.br',
  #  :authentication => :plain,
  #  :user_name => 'gustavo@clipesebandas.com.br',
  #  :password => 'hhdyatt548?>'
  #}
